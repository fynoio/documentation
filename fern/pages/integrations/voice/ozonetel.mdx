---
title: 'Voice Ozonetel Integration'
slug: 'voice-ozonetel'
description: 'Learn how to integrate Ozonetel Voice with Fyno by configuring API credentials, campaigns, caller IDs, and IVR setup for outbound and inbound voice notifications.'
og:title: 'How to send Voice notifications using Ozonetel & Fyno | Fyno Documentation'
og:description: 'Learn how to integrate Ozonetel Voice with Fyno by configuring API credentials, campaign details, and callback setup for voice call delivery tracking.'
