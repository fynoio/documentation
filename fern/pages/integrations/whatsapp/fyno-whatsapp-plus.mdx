...
og:title: 'How to send WhatsApp channel notification using Meta Direct Plus | Fyno Documentation'
og:description: 'Meta Direct Plus offers streamlined onboarding, effortless template management, and a direct billing relationship with one of the Service Providers for WhatsApp communication expenses. To set up the integration, enter a custom name, login with Facebook, complete the embedded sign-up flow, and disable 2FA authentication on your Meta phone number if necessary.'
...
<Step>Enter a Custom Name (for example: fyno-whatsapp-meta) and then click Login with Facebook. ![](/images/whatsapp_fyno_integration.png)</Step>
...
<Step>If the integration is successful, you will a success prompt. Click Add Account to complete the integration. ![](/images/whatsapp_fyno_config.png)</Step>
