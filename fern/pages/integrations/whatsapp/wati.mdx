...
<Steps>
    ...
    <Step>
        On the top navigation pane, find and click on _More -> Webhooks_
    </Step>
    <Step>
        Click 'Webhooks' to add the webhook URL (copy it from the WATI
        Integration popup) and choose status as 'Enabled'
    </Step>
    <Step>
        Select the events for which you want to receive the status in Fyno. We
        recommend adding the below shown statuses.
