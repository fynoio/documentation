...
title: 'Meta Direct'
slug: 'fyno-whatsapp'
description: 'Learn how to integrate Meta Direct WhatsApp with Fyno using embedded signup, template synchronization, direct Meta billing, and MM Lite API support.'
og:title: 'How to send WhatsApp notifications using Meta Direct | Fyno Documentation'
og:description: 'A guide to integrate Meta Direct WhatsApp with Fyno, including onboarding, template management, direct Meta billing, and MM Lite API configuration.'
