...
title: 'Meta Direct'
slug: 'fyno-whatsapp'
og:title: 'How to send WhatsApp channel notification using Meta Direct | Fyno Documentation'
og:description: 'Meta Direct offers streamlined onboarding, effortless template management, and a direct billing relationship with Meta for WhatsApp communication expenses. To set up the integration, enter a custom name, login with Facebook, complete the embedded sign-up flow, and disable 2FA authentication on your Meta phone number if necessary.'
image: https://images.fyno.io/brand/fyno-doc-preview.png
---

## Why Meta Direct

Meta Direct is Your All-in-One WhatsApp Business Solution. Onboard instantly, manage templates in a breeze, and track approvals live. All while enjoying direct billing with Meta.
...
<Tip>Use **'Meta Direct Plus'** integration, if you don't have International Credit Card and couldn't be billed by Meta directly.</Tip>
...
<Step>You will see the screen as shown below. Click Continue as button, which will redirect you to Signup flow in Meta. ![](/images/whatsapp_fyno_embedflow.png)</Step>
