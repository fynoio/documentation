---
title: 'Whatsapp Sinch Integration'
slug: 'integration/whatsapp/sinch'
og:title: 'How to send WhatsApp channel notification using Sinch & Fyno | Fyno Documentation'
og:description: 'A guide to integrate your Sinch WhatsApp account into Fyno.'
