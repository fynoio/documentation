...
<Tip>
    Keep in mind, only 5 integrations can be added per Provider, under all
    channels. For example, under the Channel SMS, when you click on Twilio, you
    can add upto 5 accounts in Twilio.
</Tip>
