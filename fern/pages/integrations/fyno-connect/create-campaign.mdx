...
metadata:
    title: "How to create a campaign in Fyno Connect"
    description: "Fyno Connect allows you to create and manage campaigns by sending bulk notifications to user cohorts through pre-configured notification events, with options for one-time or recurring campaigns, and features like delivery report integration and throttling to control notification rates."
    image: []
    robots: "index"
createdAt: "Thu Nov 14 2024 06:49:46 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Fri Nov 15 2024 06:35:47 GMT+0000 (Coordinated Universal Time)"
---
...
![](https://files.readme.io/77bb912-FynoConnect_Recurring.png)
...
2. This option allows you to receive Delivery reports of each notification triggered in any URL you have allowlisted in Fyno.
    ...
    1. Allowlisted Endpoints - Selecting Delivery Report Endpoint(s) from Verified Allowlist URLs (Maximum 3 can be selected). If you didn't allowlist any URL, you can refer this [doc](https://docs.fyno.io/docs/allowlist-url) and add a new URL
        ...
        ![](https://files.readme.io/0825e22024b4bae3a1a1df556f4090ef128c5b4b94c73e891fe0d35ffd76ac9e-allowlist_URL_connect.png)
...
![](https://files.readme.io/07a13e07a8a77044386417cf60613de7805e4618388ebb71becf8ce5c96b1689-time_throttle.png)
...
![](https://files.readme.io/9f266ea14dfe6c8fefc3519d36fb37b4dfbd856753a6d81f54e0d9c30d6cac3d-batch_throttle.png)
