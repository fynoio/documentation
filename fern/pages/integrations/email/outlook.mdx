...
hidden: false
metadata:
    title: "How to send Email notification using Outlook & Fyno | Help Document"
    description: "A guide to integrate your Outlook Email account into Fyno."
    image: []
    robots: "index"
createdAt: "Thu Dec 08 2022 07:34:03 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Thu May 02 2024 13:00:06 GMT+0000 (Coordinated Universal Time)"
---
...
1. Outlook/ Office 365 Accounts - These are almost all of the time, belonging to an organisation or company.
2. Microsoft/ Live accounts - These are personal accounts, created by signing up on Microsoft. This does not belong to a company or organisation.
...
3. To enable SMTP:
    1. In the pop-up, find "**Mail**" on the ribbon menu and find "**Manage Email Apps**".
    2. In the second pop-up that appears tick the box against **Authenticated SMTP** and save.
    3. This will enable the SMTP for you.
4. To enable App Password Creation:
5. In the same pop-up, find "**Account**" and scroll to the bottom to find "**Manage Multifactor Authentication**". This will open a fresh page.
6. On the new page, find and click "**Service Settings**" on the ribbon menu. Find and select **Allow users to create app passwords to sign in to non-browser apps** and click on **Save**.

Once this is done, you will need to create an app password.

To create an App Password:

1. Log into your account and navigate to the "**[Account Settings](https://myaccount.microsoft.com/)**". Find the **Account Info** card and click on "**Update Info**".
...
1. Log into your account through "**[Security Basics](https://account.microsoft.com/security)**" and click on the "**Advance Security Options**" card.
...
2. Under "Email" section, click on the "Outlook" button.
3. In the pop-up that appears, fill in:
    ...
    2. **Email:** The email address from which the "From" line or email will be sent. This will be the same Email ID for which the settings were updated by the Admin of your organisation.
    3. **App Password:** Follow the steps mentioned above to create the **App Password**
