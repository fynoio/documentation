...
title: 'SendGrid'
slug: 'email-sendgrid'
description: 'Learn how to integrate SendGrid with Fyno, configure API keys and sender identities, and enable event webhooks for email delivery tracking.'
og:title: 'How to send Email notification using SendGrid & Fyno | Fyno Documentation'
