...
title: 'Gmail'
slug: 'email-gmail'
description: 'Learn how to integrate a Gmail account with Fyno using Google App Passwords to send email notifications and manage sender settings.'
og:title: 'How to send Email notification using Gmail & Fyno | Fyno Documentation'
