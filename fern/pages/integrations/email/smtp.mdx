...
title: 'SMTP'
slug: 'email-smtp'
description: 'Learn how to configure a custom SMTP email provider in Fyno by setting up host details, authentication credentials, sender information, content type preferences, and delivery status notifications.'
og:title: 'How to send Email notification using SMTP & Fyno | Fyno Documentation'
