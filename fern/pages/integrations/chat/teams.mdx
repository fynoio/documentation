...
slug: 'chat-teams'
description: 'Learn how to integrate Microsoft Teams with Fyno using Incoming Webhooks or Teams Bot Apps to send notifications to channels, groups, and users.'
og:title: 'How to send MS Teams notification using Fyno | Fyno Documentation'
