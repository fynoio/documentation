...
- **Incoming Webhook:** Log into your Teams Account and:
  <Steps>
    <Step>Find the channel you want to connect to. Click on the menu option next to it and click on "**Connectors**"</Step>
    <Step>In the pop-up that opens, find "**Categories**" and select **All**.</Step>
    <Step>In the list Find **Incoming Webhook**" and click on configure.</Step>
    <Step>In the new pop-up, fill in the name, provide a logo (optional) and click on create.</Step>
    <Step>This will create. a URL in the same pop-up. This can now be used in Fyno's integration page.</Step>
  </Steps>
