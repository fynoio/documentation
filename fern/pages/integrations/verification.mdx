...
slug: 'verification'
description: 'Configure Fyno TOTP authentication for multi-factor authentication (MFA), manage tenant settings, generate one-time passwords, and monitor verification activity through logs.'
og:title: 'TOTP Authentication and Verification | Fyno Documentation'
og:description: 'Learn how to configure Fyno TOTP, customize OTP generation and verification settings, enable authenticator app integration, and track verification logs.'
