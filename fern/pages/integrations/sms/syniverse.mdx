---
title: 'SMS Syniverse Integration'
slug: 'sms-syniverse'
description: 'Learn how to integrate Syniverse SMS with Fyno by configuring access token, sender channel, and delivery event subscriptions for SMS delivery tracking.'
og:title: 'How to send SMS using Syniverse & Fyno | Fyno Documentation'
og:description: 'Learn how to integrate Syniverse SMS with Fyno by configuring access token, sender channel, and delivery event subscriptions for SMS delivery tracking.'
