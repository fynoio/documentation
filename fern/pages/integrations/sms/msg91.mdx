---
title: 'SMS MSG91 Integration'
slug: 'sms-msg91'
description: 'Learn how to integrate MSG91 SMS with Fyno by configuring your Auth Key, sender ID, and routing preferences, and setting up delivery webhooks to track SMS delivery status.'
og:title: 'How to send SMS using MSG91 & Fyno | Fyno Documentation'
og:description: 'Learn how to integrate MSG91 SMS with Fyno by configuring your Auth Key, sender ID, and routing preferences, and setting up delivery webhooks to track SMS delivery status.'
...
Navigate to the Integrations page. Under “SMS” section, click on the “MSG91” button.
...
<Steps>
    ...
    <Step> Configure the POST URL (URL can be retrieved from the integration page on Fyno):
        ![](/images/6f5b8dc-MSG91-callback.jpg)</Step>
