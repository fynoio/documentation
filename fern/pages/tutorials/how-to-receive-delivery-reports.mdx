...
<Steps>
  <Step>Select the 'Configure as Delivery Endpoint' by clicking the ellipsis as shown. <img src="/images/allowlist_configure_delivery_endpoint.png" width="500px" height="auto" style="padding:1px;border:thin solid black; </img></Step>
