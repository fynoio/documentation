---
title: 'How To Receive Delivery Reports Webhook DLR'
...
> - You can now use custom_id, custom1, and custom2 without linking them to an allow-listed URL in Fyno Connect.
> - These fields are available in a separate section, so you can configure them easily for reporting.
> - The values you set for these fields will appear in campaign-related reports available on Fyno (app.fyno.io) when downloaded.
...
![](/images/campaign-delivery-report-endpoint.png)
...
<Steps>
  ...
  <Step>It opens the page as shown below. Select the 'Do you want to receive a delivery report?' checkbox. ![](/images/allowlisted-endpoints.png)</Step>
  <Step>
