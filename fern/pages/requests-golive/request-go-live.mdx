...
hidden: false
metadata:
    title: "Request Approval and Go Live | Fyno Documentation"
    description: "This document explains how the Go Live and Requests flow works in the system, allowing users to seamlessly promote features from the Test version to Live, with options for approval and rejection by designated approvers."
    image: []
    robots: "index"
createdAt: "Wed Dec 06 2023 07:49:52 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Tue Jul 02 2024 06:48:15 GMT+0000 (Coordinated Universal Time)"
---
...
![](https://files.readme.io/498742f-Screenshot_2024-06-28_at_5.16.54_PM.png)
...
2. **Pending Approval** - All the features which are sent for Approval and yet to be approved will appear under this tab.
    ...
    1. The approver can choose one or more of the requests and click 'Approve' or 'Reject'
       ![](https://files.readme.io/243a351-Pending_Request.png)
    ...
    2. For approval, the approver needs to provide approval reason. If the approver selects, 'Go Live on approval', once the approval is done, the feature will go Live. Otherwise, the requester needs to take it Live.
       ![](https://files.readme.io/3848b8f-Approval.png)

    3. For rejection, the approver needs to provide rejection reason
       ![](https://files.readme.io/b670b56-Reject_Request.png)
