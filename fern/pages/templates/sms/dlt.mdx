...
hidden: false
metadata:
    title: "DLT templates & Guideline | Fyno Documentation"
    description: "The document explains the use of Distributed Ledger Technology (DLT) for monitoring unsolicited SMS, categorizing messages into Transactional, Service Implicit, Service Explicit, and Promotional templates, with specific examples and guidelines for template validation."
    image: []
    robots: "index"
createdAt: "Thu Jun 27 2024 09:09:29 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Wed Jul 03 2024 07:39:35 GMT+0000 (Coordinated Universal Time)"
---
