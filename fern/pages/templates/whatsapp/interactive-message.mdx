...
description: 'Create interactive WhatsApp messages in Fyno, including menus, call-to-action buttons, location requests, address requests, Meta Flows, order updates, and order details messages.'
og:title: 'Interactive WhatsApp Messages | Fyno Documentation'
og:description: 'Learn how to create and configure interactive WhatsApp messages in Fyno. Support menus, quick replies, call-to-action buttons, Meta Flows, order status updates, order details, location requests, and address collection.'
...
- [Trigger Meta Flow](#trigger-meta-flow)
...
- **Text**: Add any text content in the header.

#### Title

- Title - This is a mandatory field if you have selected Text as Header type. You can give any title to this interactive message.
...
To send this message as a reply, provide the whatsapp message ID of the corresponding message. You can provide a static value or enter a placeholder.

#### Buttons

Allows you to add call to action buttons. This is mandatory field.

- **Button Title** - This is CTA users will see as part of the interactive message.
- **URL** - This is the URL where the users will be redirected when they click the CTA button.
