---
title: 'Simple WhatsApp Messages'
slug: 'whatsapp-simple-message'
description: 'Create simple WhatsApp reply messages in Fyno using text, images, videos, audio, documents, locations, and stickers. Learn supported media types, provider compatibility, placeholders, previews, and publishing workflows.'
og:title: 'Simple WhatsApp Messages | Fyno Documentation'
og:description: 'Learn how to create simple WhatsApp reply messages in Fyno with support for text, media attachments, locations, stickers, placeholders, previews, and Go Live publishing.'
