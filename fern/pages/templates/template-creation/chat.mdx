...
![](/images/template_slack_preview.png)

The message body can be in Text or JSON depending on the kind of input. Text allows you to send simple message text whereas JSON message body is used with the Slack Block kit Builder. In case you want to use JSON, a great place to start is [Slack Block Kit Builder](https://app.slack.com/block-kit-builder). You can design your slack message at Block Kit Builder and simply copy the JSON block to Fyno Template and paste it under JSON tab. Please note: You only need to copy the JSON array start with "[" until the closing array block "]" as shown below:-

![](/images/template_slack_json.png)

<Note>Handlebars do not work on Slack's block kit builder!</Note>
...
- To tag a user specifically, you can use `<@abc.xyz>` if `abc.xyz@gmail.com` is the email id you want to tag.

### How to test a Slack template?

![](/images/template_slack_test.png)

- To send a DM, you can use `@name` in the Slack Recipient and choose the Slack provider

- To send a message to a channel, use `#channel_name`. Make sure the app you created is added to the channel where you are sending the message.
