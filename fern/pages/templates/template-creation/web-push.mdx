...
![](https://files.readme.io/c4e1440-webpush_creation.png)
...
![](https://files.readme.io/418d5fd-webpush_preview_window.png)
...
2. It opens the pop up as shown below.
   ![](https://files.readme.io/e89466c-webpush_template_updated.png)
