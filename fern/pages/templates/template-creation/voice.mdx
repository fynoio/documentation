...
description: 'Create and manage voice templates for IVR, text-to-speech, and call connect workflows across supported voice providers, including testing, dynamic content, and approval workflows.'
og:title: 'Voice Templates | Fyno Documentation'
og:description: 'Learn how to configure voice templates in Fyno for Kaleyra and Exotel, set up IVR, text-to-speech, and call connect calls, add dynamic content, test voice notifications, and manage approval requests.'
