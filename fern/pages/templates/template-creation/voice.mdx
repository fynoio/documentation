...
<Steps>
  ...
  <Step>It opens the pop up as shown below. ![](/images/voice_template_test.png)</Step>
  <Step>Enter the Mobile no of the recipient where the Voice message should be sent.</Step>
