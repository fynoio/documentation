...
title: 'RCS Templates'
slug: 'rcs-template'
description: 'Create and manage RCS templates including template messages, simple messages, rich cards, and carousels with media, buttons, dynamic content, and approval workflows.'
og:title: 'RCS Templates | Fyno Documentation'
og:description: 'Learn how to create RCS templates using template messages, simple messages, rich cards, and carousels, configure media and interactive buttons, and manage approvals.'
...
- Type - Select the type of Template you want to create. select from one of the below options. 
  <ul>
      <li>Pre-approved RCS Template</li>
      <li>Reply: Simple</li>
      <li>Reply: Card</li>
      <li>Reply: Carousel</li>
    </ul>
- Template Name - Enter the RCS template name you have created in your service provider.
- Template Type - Select from Simple, Card or Carousel
- Placeholders (Optional) - If your template uses any placeholders, you can add them here.

![](/images/rcs_template_creation.png)
...
![](/images/template_rcs_preview.png)
