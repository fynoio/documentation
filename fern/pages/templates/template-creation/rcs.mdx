...
hidden: false
metadata:
    title: "RCS Template | Fyno Documentation"
    description: "The document outlines four types of RCS (Rich Communication Services) templates: Template Message, Simple, Card, and Carousel, detailing their specific features, content requirements, and supported file types."
    image: []
    robots: "index"
createdAt: "Sun Aug 11 2024 17:36:06 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Fri Dec 20 2024 07:27:24 GMT+0000 (Coordinated Universal Time)"
---
...
![](https://files.readme.io/ae28728-RCS_Temp_message.png)
...
![](https://files.readme.io/924b505-RCS_Simple.png)
...
1. **Quick Reply**
    ...
    2. Button Payload (Optional) - Provide the payload that are sent back to the system when the button is clicked.
       ![](https://files.readme.io/815df37-button_QR.png)
...
2. **Visit Website**
    ...
    ![](https://files.readme.io/51cd4c6-button_website.png)
...
4. **Date Select** -
    ...
    6. Event Description (Optional) - Provide a description about the event.
       ![](https://files.readme.io/10a1aa6-button_dates.png)
