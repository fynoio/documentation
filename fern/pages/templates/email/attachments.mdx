...
<Note>Please note that if you are using Presigned S3 URL, then the URL should trigger a download of the file immediately when opened.</Note>
...
<Step>Replace `<BASE64 content>` with the base64-encoded content of the attachment file..</Step>
...
<Step>For file 1, you can give the below placeholders,
   ...
   <li>Content - `{{attachment.base64.0}}`</li></ul></Step>
...
<Step>For file 2, you can give the below placeholders
   ...
   <li>Content - `{{attachment.base64.1}}`</li></ul></Step>
