...
og:title: 'SMS templates types | Fyno Documentation'
og:description: "Learn about SMS template types such as Transactional, Service Implicit, Service Explicit, and Promotional, including examples and DLT-compliant formats."
