...
<Steps>
  ...
  <Step>In the External Template page, you will see the new template created along with the status. Once the status is approved or rejected by Meta, you will see the status updated in this page. ![](/images/whatsapp_approval_status.png)</Step>
</Steps>
