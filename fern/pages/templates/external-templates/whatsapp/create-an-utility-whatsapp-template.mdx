---
title: 'Create an Utility WhatsApp Template'
slug: 'external-templates/whatsapp/create-utility-whatsapp-templates'
og:title: 'How to create Utility WhatsApp template - Templates | Fyno Documentation'
og:description: 'This document explains how to create utility WhatsApp templates with up to 10 cards, submit them for approval, and common reasons for rejection.'
