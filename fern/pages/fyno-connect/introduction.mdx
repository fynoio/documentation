...
title: 'Fyno Connect'
slug: 'fyno-connect'
description: 'Learn how Fyno Connect enables you to securely create user cohorts from your databases and data warehouses, and trigger targeted campaigns without additional integrations or coding.'
og:title: 'Fyno Connect | Fyno Documentation'
og:description: 'Discover Fyno Connect, a secure self-hosted solution for building user cohorts from your databases and data warehouses and executing campaigns through Fyno Cloud.'
