...
hidden: false
metadata:
    title: "Creating a Workflow using Digest | Fyno Documentation"
    description: "Creating a Workflow using Digest"
    image: []
    robots: "index"
createdAt: "Wed Sep 11 2024 07:23:12 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Mon Dec 16 2024 06:50:42 GMT+0000 (Coordinated Universal Time)"
---
...
2. **Digest** - After adding a digest node in the workflow editor, each node below the digest node will be only triggered once in the specified digest interval. You can decide to send messages before adding a digest node and they will be triggered in real-time.
   ![](https://files.readme.io/e407db3b9237c440f76c2727b9b1e2a0071dbf4236fa5832cba967d8b09a7054-digest_digestkey.png)
...
![](https://files.readme.io/35f57e72724b934abb71335708773889680ee38baf8897b006d5648f1043bf2c-Screenshot_2024-12-16_at_12.08.42_PM.png)
...
![](https://files.readme.io/a58e07486e26b5b7f2a1e6017279fcc4b1d80cd4112231241098d6fbfc675d5e-digest_logs.png)
