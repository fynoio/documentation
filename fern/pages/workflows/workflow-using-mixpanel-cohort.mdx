...
hidden: false
metadata:
    title: "How to create a workflow using Mixpanel Cohorts | Fyno Documentation"
    description: "This document provides a detailed guide on how to configure and use Workflows in Fyno. It covers creating triggers, actions, conditions, and configuring delivery reports and overrides. It also explains how to obtain and use Workflow URLs for invoking the Workflow."
    image: []
    robots: "index"
createdAt: "Fri Apr 19 2024 12:34:20 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Fri Nov 22 2024 12:33:40 GMT+0000 (Coordinated Universal Time)"
---
...
1. Drag and drop 'Mixpanel' under Triggers into the Workflow canvas.
   ![](https://files.readme.io/3414d34-workflow_mp_custom.png)
...
3. Cohort Name - Enter a cohort name. Make sure the name matches with the Cohort created in Mixpanel
   ![](https://files.readme.io/35afc62-MP_Custom_fields.png)
...
![](https://files.readme.io/da04a48-MP_actions.png)
...
2.  **Map Data** : On selecting the notification event, you will see the Notification Event Mapping details. Basically, for the notification event that you have selected, you will need to specify which fields from the Mixpanel cohort correspond to the destination, data, callback etc.
    ![](https://files.readme.io/cbb5e48-MP_Event.png)
...
3.  **Data:** In this section, you will see all the fields that you have specified as **Placeholders** (variable parameters/dynamic values) in the **Template** that is associated with the **Notification Event** that was selected. In case you do not see this field, this means that there are no **Placeholders** in the **Template**.
    ![](https://files.readme.io/7ee8479-MP_Data.png)
...
![](https://files.readme.io/d92e66f-mp_multiple_cohorts_updated.png)
...
![](https://files.readme.io/6c50368aeca6ca11400616a9e716f260f8772a0e55abb992b8ba89070fc37bba-icon_workflow.png)
...
![](https://files.readme.io/0f5030e-Workflow_URL_2.png)
...
![](https://files.readme.io/747f6d2-Restricted_URL_2.png)
...
![](https://files.readme.io/d41fef79c97c114e24017462f6f1c3b70337bc1d7debbe443812fc9939c20a70-Mixpanel_webhook.png)

2. In the integrations, select Custom webhook and click Add connection. You will see a popup as shown

![](https://files.readme.io/475fc8e132e53775bda93f34e761db5e54699da5e367e97db934a011779c9bcd-mixpanel_config.png)
