...
description: 'Learn how to create workflows using Digest to aggregate multiple trigger events into a single notification.'
og:title: 'Creating a Workflow using Digest | Fyno Documentation'
og:description: 'Learn how to configure Digest in workflows to aggregate multiple events and send summarized notifications.'
