---
title: 'Call an API Widget within a Workflow'
slug: 'workflows/nodes-and-actions/api-widget'
og:title: 'Call an API Widget in Workflow | Fyno Documentation'
og:description: 'Learn how to configure the Call an API widget in workflows by selecting allow-listed endpoints, configuring request methods, query parameters, headers, and mapping API responses.'
