...
og:description: 'Learn how to configure the Wait for Reply widget in workflows to pause execution until a user response is received and store reply payloads in custom variables.'
