...
<Steps>
  <Step>Drag and drop 'Webhook' under Triggers into the Workflow canvas. ![](/images/0868954-workflow_trigger_webhook.png)</Step>
  <Step>
  ...
  <Step>Once you click 'Add Sample Payload', a page will open where you can enter the sample payload. ![](/images/c6a56a1-payload_json.png)</Step>
