...
<CardGroup cols={2}>
  <Card title="Flutter Push" icon={<img src="https://images.fyno.io/partners/flutter.svg" alt="Flutter Logo" />} href="./fynos-flutter-push-notification-sdk-integration-guide">
    For Flutter Mobile apps
  </Card>
  <Card title="React Native Push" icon={<img src="https://images.fyno.io/partners/react.svg" alt="React Logo" />} href="./fynos-react-native-push-notification-sdk-integration-guide">
