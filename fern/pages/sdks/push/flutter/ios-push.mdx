---
title: 'Flutter - IOS specific configuration'
slug: 'flutter-ios-specific-configuration'
description: 'Configure Apple APNs capabilities, implement required AppDelegate hooks, and provision a Notification Service Extension inside Xcode to enable rich push processing for your Flutter application.'
og:title: 'iOS Native Runtime Provisioning for Flutter Push Notifications | Fyno Documentation'
og:description: 'Configure Apple APNs capabilities, implement required AppDelegate hooks, and provision a Notification Service Extension inside Xcode to enable rich push processing for your Flutter application.'
