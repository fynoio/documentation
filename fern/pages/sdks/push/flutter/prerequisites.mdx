---
title: 'Flutter - Prerequisites Advanced Setup Requirements'
slug: 'flutter-prerequisites-advanced-setup-requirement'
description: 'Provision cloud transport configurations, cryptographic certification profiles, and system-level workspace environments before initializing the Flutter Push SDK.'
og:title: 'Infrastructure Prerequisites and Environmental Matrix Setup | Fyno Documentation'
og:description: 'Provision cloud transport configurations, cryptographic certification profiles, and system-level workspace environments before initializing the Flutter Push SDK.'
...
- Configure your Fyno Push provider in Fyno App > [Integrations](https://app.fyno.io/integrations).
