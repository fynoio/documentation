...
description: 'Provision and configure the native Kotlin SDK inside your Android workspace. Learn how to link core contexts, register Firebase or Xiaomi OEM push targets, and track message lifecycle callbacks.'
og:title: 'Native Android (Kotlin) Push Notification SDK | Fyno Documentation'
og:description: 'Provision and configure the native Kotlin SDK inside your Android workspace. Learn how to link core contexts, register Firebase or Xiaomi OEM push targets, and track message lifecycle callbacks.'
...
2.  **Initialisation:** Fyno Push SDK is responsible for handling push rendering and push amplification.
    ...
    - **Push Amplification:** To make use of push amplification follow [Mi Push Documentation](./push-mi-push) to implement Xiaomi push
