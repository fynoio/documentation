---
title: 'Web Component Integration with React In-App SDK'
slug: 'fyno-in-app-react-sdk'
description: 'Embed a modular notification center inside web applications using the React In-App UI kit. Master unified state configuration, custom style injections, and cross-origin sound handling.'
og:title: 'Web Component Integration with React In-App SDK | Fyno Documentation'
og:description: 'Embed a modular notification center inside web applications using the React In-App UI kit. Master unified state configuration, custom style injections, and cross-origin sound handling.'
