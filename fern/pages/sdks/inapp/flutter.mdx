---
title: 'Cross-Platform Client Engineering with Flutter In-App SDK'
slug: 'fyno-flutter-inapp-sdk'
description: 'Embed real-time notification hubs across mobile and web environments using the Flutter In-App library. Master backend HMAC token derivation, reactive state variables, and visual rendering overrides.'
og:title: 'Cross-Platform Client Engineering with Flutter In-App SDK | Fyno Documentation'
og:description: 'Embed real-time notification hubs across mobile and web environments using the Flutter In-App library. Master backend HMAC token derivation, reactive state variables, and visual rendering overrides.'
