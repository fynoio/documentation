...
> - If you are developing for the web, please ensure that your project is using Flutter In-App SDK v1.2.0 or later to access and benefit from web compatibility. Projects using the earlier versions of the SDK will not support web-based implementations.
