---
title: 'Orchestrating Silent and Background Data Payloads'
slug: 'silent-background-notifications'
description: 'Transmit real-time configuration signals and application state variables without triggering visual UI popups. Learn how to design silent templates and handle background data sync listeners.'
og:title: 'Orchestrating Silent and Background Data Payloads | Fyno Documentation'
og:description: 'Transmit real-time configuration signals and application state variables without triggering visual UI popups. Learn how to design silent templates and handle background data sync listeners.'
