...
description: 'Integrate native browser remote push capabilities into your web applications. Configure customizable permission prompts, VAPID token authorization keys, and background service workers.'
og:title: 'Web Push Notification SDK | Fyno Documentation'
og:description: 'Integrate native browser remote push capabilities into your web applications. Configure customizable permission prompts, VAPID token authorization keys, and background service workers.'
...
```javascript
importScripts('https://cdn.jsdelivr.net/npm/@fyno/websdk@<latest_version>/sw/serviceworker.min.js');
```
