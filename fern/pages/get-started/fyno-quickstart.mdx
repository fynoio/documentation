...
You can get deeper analytics like delivery and open rates for each notification event from your [Notification Event Analytics](../notification-event-analytics) section.
