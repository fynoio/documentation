...
<Tip>We’ve got 40+ integrations pre-loaded on the platform. Head over to the integrations tab of the platform to check them out.</Tip>
...
<Tip>In most cases, we have seen that notification events and templates carry the same name for ease of identification. Example: An “Out for Delivery” notification event will always use the “Out for Delivery” template.</Tip>
