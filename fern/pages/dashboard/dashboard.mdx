...
<Tip title="Hover over the graphs for more details!">Hoving over any graph gives you more details about that point on the visualization. Go head, try it!</Tip>
