...
The **Allowlist** is a registry of verified external destinations, such as Webhook URLs and Amazon SQS queues, that can securely interact with Fyno. These destinations must be added and verified before they can be used inside workflows, delivery reporting, or other integrations within the platform.
