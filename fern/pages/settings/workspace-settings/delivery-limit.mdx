...
hidden: false
metadata:
    title: "Delivery Limit | Fyno Documentation"
    description: "Enables users to set notification delivery controls. Do Not Disturb enables them to not disturb users in a pre-defined time slots. Frequency Capping enables them to define and control the maximum no of notification a user can receive in a particular duration, thus avoiding spamming the user"
    image: []
    robots: "index"
createdAt: "Wed Dec 13 2023 12:04:47 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Thu Jun 20 2024 06:58:38 GMT+0000 (Coordinated Universal Time)"
---
...
![](https://files.readme.io/4c216c5-DND_Marketing.png)
...
![](https://files.readme.io/4211224-Marketing_Frequency_Capping.png)
