...
| provider_template_id | **String**; the provider template ID that was sent.<br/>For SMS, the DLT template ID is sent (for Indian users).<br/>For WhatsApp, the template name and language is sent (`templatename_lang`).<br/>For RCS, the template name is sent.                                                                                                                                                     |
