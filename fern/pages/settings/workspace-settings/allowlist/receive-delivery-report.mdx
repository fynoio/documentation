...
<Steps>
  <Step>Select the checkbox - 'Use this endpoint to receive delivery reports' and click 'Add'.</Step>
  <Step>In the window that opens, you can add additional configurations, based on your requirements. You can also alternatively scroll to the bottom and save. This will send you the basic details that are pre-configured at Fyno's end.</Step>
</Steps>
...
```json title="Sample Payload" wordWrap
{
     "param1": "{{destination}}",
     "param2": "{{provider}}",
