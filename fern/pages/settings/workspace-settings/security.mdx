...
<Steps>
  <Step>Tap on **Workspace Settings** on the bottom left corner of the navigation menu and click '**Security**' which opens up the Security page.</Step>
  <Step>Then find the **HMAC Key for API Calls** option and toggle it "on".</Step>
  <Step>Add a secret key and save.</Step>
</Steps>

Fyno will use the secret key to encrypt the JSON payload and create a signature and send it as part of the API request header.
