...
export const tableWrapperStyle = {
  overflowX: 'auto',
  overflowY: 'auto',
  maxHeight: '520px', /* Bounded vertical height to enable inner row scrolling */
...
export const tableStyle = {
  width: '100%',
  borderCollapse: 'separate', /* Ensures standard cell stickiness context */
  borderSpacing: 0,
  fontSize: '13px',
...
export const thStyle = {
  position: 'sticky',
  top: '-8px', /* Aligns perfectly with the inner boundary edge */
  zIndex: 20,
...
export const tdStyle = {
  ...
  backgroundColor: 'var(--rb-table-bg, #FFFFFF)' /* Opaque backplate protects header clear space */
};
...
export const TableHeader = ({ text }) => (
  <tr>
    <td colSpan="8" style={{
      position: 'sticky',
      top: '35px', /* Anchors smoothly just below the primary header row */
      zIndex: 10,
...
{/* Style Block for Dark Mode Switch Management */}
<style>{`
  :root {
    --rb-table-bg: #FFFFFF;
