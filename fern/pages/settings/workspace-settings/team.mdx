...
<div style={tableWrapperStyle}>
  <table style={tableStyle}>
    ...
    <tr>
      ...
      <td style={tdStyle}>
        <Badge type="yes" text="Yes" />
      </td>
      <td style={tdStyle}>
        <Badge type="yes" text="Yes" />
      </td>
      <td style={tdStyle}>
        <Badge type="yes" text="Yes, except push token cleanup" />
      </td>
      <td style={tdStyle}>
        <Badge type="yes" text="Yes, except push token cleanup" />
      </td>
      <td style={tdStyle}>
        <Badge type="view" text="View only" />
      </td>
      <td style={tdStyle}>
        <Badge type="view" text="View only" />
      </td>
      <td style={tdStyle}>
        <Badge type="no" text="No" />
      </td>
    </tr> {/* <--- Double check that this closing tag is present and typed correctly */}
      <tr>
