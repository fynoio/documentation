...
description: 'Automatically remove inactive and invalid push notification tokens to improve delivery accuracy and maintain clean user profiles.'
og:title: 'Push Token Cleanup - Add-Ons | Fyno Documentation'
og:description: 'Learn how to enable Push Token Cleanup to automatically remove stale, unregistered, or uninstalled device tokens and improve push notification delivery metrics.'
...
<Steps>
  <Step>Tap on **Workspace Settings** on the bottom left corner of the navigation menu and click '**Add Ons**' which opens up the Alerts page.</Step>
  <Step>Find the **Push Token Cleanup** toggle and activate it.</Step>
</Steps>
