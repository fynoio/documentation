---
title: 'Debugging Notification Hops with Log Trace'
slug: 'log-details-trace'
description: "Learn how to analyze the end-to-end lifecycle of a notification using Fyno's execution Trace log to pinpoint latency and delivery drops."
og:title: 'Debugging Notification Hops with Log Trace | Fyno Documentation'
og:description: "Learn how to analyze the end-to-end lifecycle of a notification using Fyno's execution Trace log to pinpoint latency and delivery drops."
