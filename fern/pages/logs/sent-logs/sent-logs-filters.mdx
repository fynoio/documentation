...
og:title: 'Filters - Sent Logs | Fyno Documentation'
og:description: 'The document explains how to use various filters on the sent logs page of the Fyno App to efficiently search and manage notification logs, including filters for date range, search terms, destination, templates, channels, providers, account names, event names, placeholders, and status.'
---
