...
og:title: 'Notification Event Logs - Notification Events | Fyno Documentation'
og:description: 'The document explains how to navigate and use the Notification Event logs on the Fyno platform, detailing the components and filters available to track and analyze notification events, and improve communication strategies. It also describes how to access logs, interpret log details, and use filters to narrow down searches, with a focus on understanding the status and flow of notifications.'
