...
metadata:
    title: "Delivery Callback Logs"
    description: "This document explains how callback logs can help track delivery reports sent to your Allowlist URL, providing details such as timestamp, notification event, channel, HTTP status code, and response time. It also includes information on filters for date range, message ID, custom ID, and HTTP status code, with the ability to view individual callback log details."
    image: []
    robots: "index"
createdAt: "Tue May 07 2024 06:58:34 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Thu Jul 18 2024 07:11:44 GMT+0000 (Coordinated Universal Time)"
---
...
![](https://files.readme.io/fb7ca5c-Delivery_Callback_Logs.png)
...
![](https://files.readme.io/096c8af-Callback_details_new.png)
