...
<Steps>
  ...
  <Step>Select Subscription topic from the list of subscriptions created in User Preferences. This is an optional field. Please refer this [documentation](https://docs.fyno.io/docs/user-preferences) on how to create subscription</Step>
