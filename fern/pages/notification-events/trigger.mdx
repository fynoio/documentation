...
From the **[Notification Events](./notification-event-logs)** section:
...
- **[Logs](./notification-event-logs)**: When the notification event is triggered, the logs that would be generated can be seen on the logs tab as well for a quick overview of the status.
