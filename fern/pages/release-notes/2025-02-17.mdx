...
- **Templates**: Added a Handlebars function to [convert numbers into words](./templates-handlebars#convert-number-to-words).
...
- **User Profiles**: Now supports all **ISO 8601 date-time formats** for [date type properties](./api-reference/user-properties/post-wsid-version-profiles-properties-set).
- **Dashboard**: **Notification Event analytics** now shows "Verified" Data if you use [Fyno Verify](./fyno-verify).
