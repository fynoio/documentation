...
- **Workflow Journey Branching**
  - Introduced support to **branch workflow based on previous event status**, allowing workflows to conditionally continue or restart based on past fired journey.
