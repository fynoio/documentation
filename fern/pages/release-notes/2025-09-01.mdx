...
Introduced an Approver-only role, enhanced callbacks, campaigns, templates, and SDK performance to improve usability, flexibility, and platform efficiency.
Resolved workflow, template, and API issues while strengthening platform security with successful VAPT certification.
