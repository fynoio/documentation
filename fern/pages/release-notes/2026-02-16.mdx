...
- **Authentication**
  ...
  - **Improved Login Error Messages**: The login form now shows accurate error messages instead of always displaying “Email or Password is invalid.”

- **User Profiles**

  - **Profile Page Crash – Missing Consent Object**: Resolved a runtime error (`generateDefaultConsentObject is not defined`) when opening the profile page.
