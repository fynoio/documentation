...
- **Fyno Cloud** – Optimized the placement of the DevRev chat widget.
...
- **Integrations** – Added support for the Twilio URL shortener in SMS.
...
- **Omni-Channel Routes** – Corrected issues with router creation from the Notification Events page.
- **Alarms**
  - Fixed various UI-related issues.
  - Enhanced exclusion list handling and error messaging.
  - Corrected formatting for "No DLR Alarms" to reflect the correct severity levels (e.g., info, low, medium, high).
