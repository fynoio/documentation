...
Refined campaign visibility with improved status display, adds unsaved changes warnings for safer edits, enhances workflow condition search, and fixes issues across alarms, dashboards, cookies, and external templates for a smoother user experience.     
